// bits/memory/uninitialized_default_construct.hpp
//
...
struct uninitialized_default_construct_fn
{
  public:
    ...
    ranges::safe_iterator_t<Rng>
    operator()(Rng&& rng) const { return uninitialized_default_construct_fn::impl(begin(rng), end(rng)); }
  private:
    ...
    static I impl(I first, S last)
    {
        I it = first;
        for (; it != last; ++it) {
            new (detail::voidify(*it)) remove_reference_t<iter_reference_t<I>>;
        }
        return it;
    }
};
...
__DEF_NIEBLOID(detail::uninitialized_default_construct_fn, uninitialized_default_construct)
...
struct uninitialized_default_construct_n_fn
{
    ...
    {
        return uninitialized_default_construct(make_counted_iterator(std::move(first), n), default_sentinel).base();
    }
};

}

__DEF_NIEBLOID(detail::uninitialized_default_construct_n_fn, uninitialized_default_construct_n)
